package com.yuhuayuan.core.aliyun;
...
public class ObjectUpLoad {
    ...
    private static String accessKeyId = "EtjtV5XRoYEPgBEp";
    private static String accessKeySecret = "GvJNsI715akOq9WsfXxkA8W6DxbDQp";

    private static String bucketName = "yhypic";
    private static String key = "123456.txt";
    
    public static void upLoadAliyunTest() throws IOException {
        /*
